...
public class IrsaService {
    ...
    public IrsaResponse calculate(Long municipalityId) {
        ...
        LOG.infof("[IRSA] Municipio=%s | NO2=%.4f O3=%.4f PM25=%.4f UV=%.4f TMP=%.4f | C=%.4f | FV=%.4f | IRSA=%.2f | Nivel=%s",
                ...
                result.contaminantes(), result.factorVulnerabilidad(),
    ...
    private Irsa buildIrsa(Municipality municipality, IrsaResult r) {
        ...
        irsa.setContaminantes(r.contaminantes());
        ...
        irsa.setFactorVulnerabilidad(r.factorVulnerabilidad());
        return irsa;
    }
}
