...
public class IrsaEngine {
    ...
    public IrsaResult calculate(
        ...
        double pollutantScore = (IrsaWeightConfig.W_NO2  * normNo2)
        ...
        double vulnerabilityFactor = 1.0
        ...
        double irsaScore = pollutantScore * (vulnerabilityFactor / 2.0) * 100.0;
        ...
        return new IrsaResult(
                ...
                round4(normUv),
                round4(normTmp),
                round4(pollutantScore),
                round4(prevCopd),
                round4(prevAsthma),
                round4(prevPneumonia),
                round4(prevSmoking),
                round4(vulnerabilityFactor),
                round4(irsaScore),
